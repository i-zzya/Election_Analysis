...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dict:
        ...
        if (county_votes > largest_votes) and (county_percentage > winning_county_percentage):
            winning_county_votes = county_votes
            winning_county = county_name
            winning_county_percentage = county_percentage

    # 7: Print the county with the largest turnout to the terminal.
        winning_votes_summary = (
            f"-------------------------\n"
            f"Largest County Turnout: {winning_county}\n"
            f"-------------------------\n")
    print(winning_votes_summary)

    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(winning_votes_summary)
